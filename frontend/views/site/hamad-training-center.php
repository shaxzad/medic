					...
					<div role="tabpanel" id="#myTab" class="nav nav-tabs">
						<ul role="tablist" class="nav nav-tabs">
							<li role="presentation" class="active">
								<a href="#1tab" aria-controls="1tab" role="tab" data-toggle="tab">HITC</a>
							</li>
							<li role="presentation">
								<a href="#2tab" aria-controls="2tab" role="tab" data-toggle="tab">Courses</a>
							</li>
							<li role="presentation">
								<a href="#3tab" aria-controls="3tab" role="tab" data-toggle="tab">eLearning</a>
							</li>
							<li role="presentation">
								<a href="#4tab" aria-controls="4tab" role="tab" data-toggle="tab">Our Instructors</a>
							</li>
							<li role="presentation">
								<a href="#5tab" aria-controls="5tab" role="tab" data-toggle="tab">Application Registration</a>
							</li>
							<li role="presentation">
								<a href="#6tab" aria-controls="6tab" role="tab" data-toggle="tab">School Activites</a>
							</li>
							<li role="presentation">
								<a href="#7tab" aria-controls="7tab" role="tab" data-toggle="tab">Kulluna</a>
							</li>
						</ul>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="mv30">
												...
												<p>
													I am pleased to introduce Hamad International Training Center (HITC) as part of Hamad Medical Corporation's scientific and academic activities. HITC started with a vision of improving overall healthcare in Qatar through providing quality training in trauma management, disaster management and resuscitation, as well as public training and awareness programs.
 
													HITC also gained the support and recognition of Hamad Medical Corporation leadership and received the ultimate honor by the recognition of its efforts when His Highness, then the Heir Apparent bestowed his support on the 
												</p>
												<h3>About Us </h3>
												<p>
													The Hamad International Training Center (HITC), part of Hamad Medical Corporation, provides opportunities for physicians, nurses and paramedics to continue their professional and personal development. With HITC healthcare professionals can improve their competence and skills in order to provide the highest standards of patient care, using the latest knowledge, theories and technology. The center also provides opportunities for institutions and members of the public to take part in courses and events that raise public awareness.
												</p>
											</div> 
										</div>
									</div>

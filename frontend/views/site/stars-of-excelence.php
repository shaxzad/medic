...
<section class="hide-arrow">
    <div class="container">
    <div id="section1">
        <div id="carousel-area-construction" class="fitness-mp-slider">
            <div id="car-slider" class="owl-carousel">
                <div style="background: url(<?php echo yii::getAlias('@web'). '/theme/img/aboutus/1.jpg'; ?>);height:400px !important" class="bg-cover slider-wow fadeIn">
